...
class TestMLBTeams:
    ...
    def test_is_valid_team_valid(self):
        """Test is_valid_team with valid teams"""
        assert is_valid_team('NYM') is True
        assert is_valid_team('nym') is True  # lowercase
        assert is_valid_team('LAD') is True

    def test_is_valid_team_invalid(self):
        """Test is_valid_team with invalid teams"""
        assert is_valid_team('XYZ') is False
        assert is_valid_team('') is False

    def test_get_team_id_valid(self):
        """Test get_team_id with valid teams"""
        assert get_team_id('NYM') == 121
        assert get_team_id('nym') == 121  # lowercase
        assert get_team_id('LAD') == 119

    def test_get_team_id_invalid(self):
        """Test get_team_id with invalid teams"""
...
@pytest.mark.unit
class TestGetAdjacentGames:
    """Tests for the get_adjacent_games function"""

    @patch('statsapi.schedule')
    def test_returns_prev_and_next_game(self, mock_schedule):
        """Test finding previous and next games around a given date"""
        mock_schedule.return_value = [
            {'game_id': 100, 'game_date': '2025-04-14', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 200, 'game_date': '2025-04-15', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 300, 'game_date': '2025-04-17', 'game_num': 1, 'doubleheader': 'N'},
        ]

        prev_game, next_game = get_adjacent_games(121, '2025-04-15', 200)
    ...
    def test_no_previous_game(self, mock_schedule):
        """Test when there is no previous game (start of season)"""
        mock_schedule.return_value = [
            {'game_id': 200, 'game_date': '2025-04-15', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 300, 'game_date': '2025-04-17', 'game_num': 1, 'doubleheader': 'N'},
        ]
    ...
    def test_no_next_game(self, mock_schedule):
        """Test when there is no next game (end of season)"""
        mock_schedule.return_value = [
            {'game_id': 100, 'game_date': '2025-04-14', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 200, 'game_date': '2025-04-15', 'game_num': 1, 'doubleheader': 'N'},
        ]
    ...
    @patch('statsapi.schedule')
    def test_doubleheader_game1_to_game2(self, mock_schedule):
        """Test navigation from game 1 to game 2 of a doubleheader"""
        mock_schedule.return_value = [
            {'game_id': 100, 'game_date': '2025-04-14', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 200, 'game_date': '2025-04-15', 'game_num': 1, 'doubleheader': 'S'},
            {'game_id': 201, 'game_date': '2025-04-15', 'game_num': 2, 'doubleheader': 'S'},
            {'game_id': 300, 'game_date': '2025-04-17', 'game_num': 1, 'doubleheader': 'N'},
        ]
        ...
        assert prev_game == {'date': '2025-04-14', 'game_num': 1}
        assert next_game == {'date': '2025-04-15', 'game_num': 2}

    @patch('statsapi.schedule')
    def test_doubleheader_game2_to_next_day(self, mock_schedule):
        """Test navigation from game 2 of a doubleheader to next day"""
        mock_schedule.return_value = [
            {'game_id': 100, 'game_date': '2025-04-14', 'game_num': 1, 'doubleheader': 'N'},
            {'game_id': 200, 'game_date': '2025-04-15', 'game_num': 1, 'doubleheader': 'S'},
            {'game_id': 201, 'game_date': '2025-04-15', 'game_num': 2, 'doubleheader': 'S'},
        ...
        prev_game, next_game = get_adjacent_games(121, '2025-04-15', 201)

        assert prev_game == {'date': '2025-04-15', 'game_num': 1}
        assert next_game == {'date': '2025-04-17', 'game_num': 1}
...
class TestGetLineup:
    ...
    @patch('mlb.api_client.get_player_details')
    @patch('requests.get')
    def test_get_lineup_success(self, mock_get, mock_player_details, mock_boxscore_response):
        ...
        mock_player_details.return_value = {'jersey': '10', 'name': 'Player 1'}
    ...
    @patch('mlb.api_client.get_player_details')
    @patch('requests.get')
    def test_get_lineup_no_batting_order(self, mock_get, mock_player_details, mock_boxscore_response):
...
class TestGetProbablePitchers:
    ...
    @patch('mlb.api_client.get_pitchers_from_boxscore')
    ...
    @patch('mlb.api_client.get_pitchers_from_schedule')
    ...
    @patch('mlb.api_client.get_pitchers_from_boxscore')
    @patch('mlb.api_client.get_pitcher_details')
...
class TestSubstitutionHandling:
    ...
    def test_get_lineup_filters_substitutes(self, mock_boxscore_data, mock_player_details, mock_boxscore_data_with_substitutes):
        ...
        mock_player_details.return_value = {'jersey': '12', 'name': 'Test Player'}
    ...
    @patch('mlb.api_client.get_player_details')
    @patch('statsapi.boxscore_data')
    def test_lineup_batting_order(self, mock_boxscore_data, mock_player_details, mock_boxscore_data_with_substitutes):
